  ...
  apply(ctx) {
    ...
    if (tools && typeof tools.register === 'function') {
      ...
      const modeTool = makeJsonTool(
        'sme3d_mode',
        '查看或切换 3D 记忆模式（共 9 种：chat 对话记忆 / semantic 语义记忆 / focus 只记事实 / v2 深度对话 / kb_dynamic 知识库动态 / kb_static 知识库静态 / robot 具身机器人 / minimal 裸向量库 / project 项目记忆）。不传 id 列出全部模式；传 id 则切换。注意：每种模式的存储完全独立，切换到的模式若从未写过即为空白记忆。',
        {
          type: 'object',
          properties: {
